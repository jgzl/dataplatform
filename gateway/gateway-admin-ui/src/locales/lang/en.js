export default {
	login: {
		...
		describe: 'Zhiyan Data Innovation Gateway is developed based on Spring Cloud Gateway, providing service forwarding, service fuse, service degradation, and is committed to creating an external integrated open platform to improve customer experience!',
		signInTitle: 'Sign in',
