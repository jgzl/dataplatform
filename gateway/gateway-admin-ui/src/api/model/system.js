...
export default {
	menu: {
		myMenus: {
			url: `${config.API_URL}/admin/system/menu/tree/user`,
			name: "获取我的菜单",
			get: async function(){
		...
		tree: {
			url: `${config.API_URL}/admin/system/menu/tree`,
			name: "获取菜单-树",
			get: async function(){
				return await http.get(this.url);
			}
		...
		save: {
			url: `${config.API_URL}/admin/system/menu`,
			name: "保存菜单",
	...
	dic: {
		tree: {
			url: `${config.API_URL}/admin/system/dic/tree`,
			name: "获取字典树",
			get: async function(){
				return await http.get(this.url);
			}
		...
		list: {
			url: `${config.API_URL}/admin/system/dic/list`,
			name: "字典明细",
		...
		get: {
			url: `${config.API_URL}/admin/system/dic/get`,
			name: "获取字典数据",
			get: async function(params){
				return await http.get(this.url, params);
			}
	...
	role: {
		page: {
			url: `${config.API_URL}/admin/system/role/page`,
			name: "获取角色列表-分页",
			get: async function(params){
				return await http.get(this.url, params);
			}
		...
		save: {
			url: `${config.API_URL}/admin/system/role`,
			name: "保存角色",
			post: async function(params){
				return await http.post(this.url, params);
			}
		...
		menu: {
			url: `${config.API_URL}/admin/system/role/menu`,
			name: "更新角色-菜单",
			put: async function(params){
				return await http.put(this.url, params);
			}
	...
	dept: {
		tree: {
			url: `${config.API_URL}/admin/system/dept/tree`,
			name: "获取部门列表-树",
			get: async function(params){
				return await http.get(this.url, params);
			}
		...
		save: {
			url: `${config.API_URL}/admin/system/dept`,
			name: "保存部门",
			post: async function(params){
				return await http.post(this.url, params);
			}
	...
	user: {
		page: {
			url: `${config.API_URL}/admin/system/user/page`,
			name: "获取用户列表-分页",
			get: async function(params){
				return await http.get(this.url, params);
			}
		...
		save: {
			url: `${config.API_URL}/admin/system/user`,
			name: "保存用户",
			post: async function(params){
				return await http.post(this.url, params);
			}
	...
	table: {
		list: {
			url: `${config.API_URL}/admin/system/table/list`,
			name: "表格列管理列表",
			get: async function(params){
				return await http.get(this.url, params);
			}
		...
		info: {
			url: `${config.API_URL}/admin/system/table/info`,
			name: "表格列管理详情",
			get: async function(params){
				return await http.get(this.url, params);
			}
	...
	tasks: {
		list: {
			url: `${config.API_URL}/admin/system/tasks/list`,
			name: "系统任务管理",
			get: async function(params){
				return await http.get(this.url, params);
			}
	...
	errorCode: {
		page: {
			url: `${config.API_URL}/admin/system/error-code/page`,
			name: "获取错误码列表-分页",
			get: async function(params){
				return await http.get(this.url, params);
			}
		...
		list: {
			url: `${config.API_URL}/admin/system/error-code/list`,
			name: "获取错误码列表",
			get: async function(params){
				return await http.get(this.url, params);
			}
		...
		save: {
			url: `${config.API_URL}/admin/system/error-code`,
			name: "保存错误码",
			post: async function(params){
				return await http.post(this.url, params);
			}
