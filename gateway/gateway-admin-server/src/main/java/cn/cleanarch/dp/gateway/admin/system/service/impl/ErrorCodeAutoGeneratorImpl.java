...
public class ErrorCodeAutoGeneratorImpl implements ErrorCodeAutoGenerator {
    ...
    public void execute() {
        // 第一步，解析错误码
        List<SysErrorCodeAutoGenerateReqDTO> autoGenerateDTOs = parseErrorCode();
     ...
     * @return 错误码数组
     */
    private List<SysErrorCodeAutoGenerateReqDTO>  parseErrorCode() {
        ...
        // 解析错误码
        List<SysErrorCodeAutoGenerateReqDTO> autoGenerateDTOs = new ArrayList<>();
     ...
     * @return 错误码数组
     */
    private List<SysErrorCodeAutoGenerateReqDTO> parseErrorCode(Class<?> constantsClass) {
        List<SysErrorCodeAutoGenerateReqDTO> autoGenerateDTOs = new ArrayList<>();
        Arrays.stream(constantsClass.getFields()).forEach(field -> {
            ...
            autoGenerateDTOs.add(new SysErrorCodeAutoGenerateReqDTO().setApplicationName(applicationName)
