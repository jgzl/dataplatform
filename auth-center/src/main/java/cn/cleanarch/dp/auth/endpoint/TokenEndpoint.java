...
import cn.cleanarch.dp.system.sys.feign.RemoteClientDetailsService;
import cn.cleanarch.dp.system.sys.vo.user.TokenVO;
	...
	public ModelAndView confirm(Principal principal, ModelAndView modelAndView,
		...
		SysOauthClientDetailsDO clientDetails = RetOps
				...
				.orElseThrow(() -> {
					...
					return new OAuthClientException("clientId 不合法");
				});
