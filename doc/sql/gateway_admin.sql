...
INSERT INTO `gateway_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `sort`, `metadata`, `create_time`, `update_time`, `creator`, `updater`, `deleted`, `version`) VALUES ('3', '', 'auth-center', '[{\"args\": {\"_genkey_0\": \"/auth/**\"}, \"name\": \"Path\"}]', '[]', 'lb://auth-center', 0, '{\"version\": \"1\"}', '2021-12-27 02:43:25', '2022-01-06 02:40:46', '1', '1', '0', 1);
INSERT INTO `gateway_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `sort`, `metadata`, `create_time`, `update_time`, `creator`, `updater`, `deleted`, `version`) VALUES ('4', '', 'system-center', '[{\"args\": {\"_genkey_0\": \"/system/**\"}, \"name\": \"Path\"}]', '[]', 'lb://system-center', 0, '{\"version\": \"1\"}', '2021-12-27 02:43:25', '2022-01-06 02:40:46', '1', '1', '0', 1);
