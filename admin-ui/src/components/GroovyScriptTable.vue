	...
	<div>
        <el-table size="small" :data="tableData" style="width: 100%" height="600">
            ...
            <el-table-column label="状态" prop="status" width="120">
                <template v-slot:default="scope">
                    <div v-if="scope.row.status==='0'"><i class="el-icon-success" style="color: #409EFF;"></i>&nbsp;<el-tag size="small">{{'开启'}}</el-tag></div>
                    <div v-if="scope.row.status==='1'"><i class="el-icon-error" style="color: #f00000;"></i>&nbsp;<el-tag size="small" type="danger">{{'关闭'}}</el-tag></div>
                </template>
            </el-table-column>
