	...
	<div>
		<el-dialog title="监控告警信息" v-model="dialogFormVisible" width="25%" :close-on-click-modal="false">
			<el-form :model="infoForm" ref="infoForm" :label-width="formLabelWidth">
				...
				<el-form-item label="服务地址：" size="small">
					<el-tag size="small" type="success">{{infoForm.uri}}</el-tag>
				</el-form-item>
				<el-form-item label="断言路径：" size="small">
					<el-tag size="small" type="success">{{infoForm.path}}</el-tag>
				</el-form-item>
				<el-form-item v-show="infoForm.method != ''" label="请求模式：" size="small">
					<el-tag size="small" type="success">{{infoForm.method}}</el-tag>
				</el-form-item>
				<el-form-item label="告警状态：" size="small">
				...
				<el-form-item v-show="infoForm.status == '2'" label="告警时间：" size="small">
					<el-tag size="small" type="danger" effect="dark">{{infoForm.alarmTime}}</el-tag>
				</el-form-item>
				<el-form-item label="告警重试：" size="small">
				...
				<el-form-item label="通知频率：" size="small">
				...
				<el-form-item v-show="infoForm.emails != null && infoForm.emails != ''" label="通知邮箱：" size="small">
					<el-tag size="small" type="" effect="dark">{{infoForm.emails}}</el-tag>
				</el-form-item>
				<el-form-item v-show="infoForm.sendTime != null && infoForm.sendTime != ''" label="通知时间：" size="small">
