			...
			<el-table size="small" :data="routeTableData" style="width: 100%">
				...
				<el-table-column label="操作" width="60">
					<template v-slot:default="scope">
						<el-button size="small" circle icon="el-icon-plus" type="success" title="添加" @click="handleAddRegServer(scope.row)"></el-button>
					</template>
				</el-table-column>
			</el-table>
...
<script>
	...
	export default {
		...
		methods:{
			...
			goBack() {
			    console.log('go back');
				this.$router.push({path:'/gateway/dashboard/clientList',query:{}});
			},
