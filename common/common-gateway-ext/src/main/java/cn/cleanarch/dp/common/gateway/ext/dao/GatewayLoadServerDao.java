 ...
 * @Version V1.0
 */
public interface GatewayLoadServerDao extends JpaRepository<GatewayLoadServerDO, Long> {
     ...
     * @return
     */
    List<GatewayLoadServerDO> queryByBalancedId(String balancedId);
     ...
     * @return
     */
    List<GatewayLoadServerDO> queryByRouteId(String routeId);
