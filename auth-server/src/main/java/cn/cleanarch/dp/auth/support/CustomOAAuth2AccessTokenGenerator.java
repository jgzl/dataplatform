package cn.cleanarch.dp.auth.support;
 ...
 * @date 2022/5/29
 */
public class CustomOAAuth2AccessTokenGenerator implements OAuth2TokenGenerator<OAuth2AccessToken> {
	...
	public OAuth2AccessToken generate(OAuth2TokenContext context) {
		...
		return new CustomOAAuth2AccessTokenGenerator.OAuth2AccessTokenClaims(OAuth2AccessToken.TokenType.BEARER, key,
