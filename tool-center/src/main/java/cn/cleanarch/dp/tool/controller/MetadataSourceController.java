...
import cn.cleanarch.dp.common.database.core.PageResult;
...
import cn.cleanarch.dp.tool.metadata.query.DbDataQuery;
import cn.cleanarch.dp.tool.metadata.query.MetadataSourceQuery;
...
public class MetadataSourceController {
    ...
    public R getMetadataSourceById(@PathVariable String id) {
        ...
        return R.success(metadataSourceMapper.toVO(metadataSourceEntity));
    }
    ...
    public R checkConnection(@RequestBody @Validated({ValidationGroups.Insert.class}) MetadataSourceDto metadataSourceDto) {
        ...
        return valid ? R.success() : R.error("数据库连接有误，请检查数据库配置是否正确");
    }
