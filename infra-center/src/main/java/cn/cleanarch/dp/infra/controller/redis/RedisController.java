package cn.cleanarch.dp.infra.controller.redis;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.cleanarch.dp.common.core.model.R;
import cn.cleanarch.dp.common.redis.RedisKeyDefine;
import cn.cleanarch.dp.common.redis.RedisKeyRegistry;
import cn.cleanarch.dp.infra.vo.redis.RedisKeyDefineRespVO;
import cn.cleanarch.dp.infra.vo.redis.RedisKeyValueRespVO;
import cn.cleanarch.dp.infra.vo.redis.RedisMonitorRespVO;
import cn.cleanarch.dp.infra.convert.redis.RedisConvert;
...
public class RedisController {
    ...
    //@PreAuthorize("@pms.hasPermission('infra:redis:get-monitor-info')")
    public R<RedisMonitorRespVO> getRedisMonitorInfo() {
        // 获得 Redis 统计信息
    ...
    //@PreAuthorize("@pms.hasPermission('infra:redis:get-key-list')")
    public R<List<RedisKeyDefineRespVO>> getKeyDefineList() {
    ...
    //@PreAuthorize("@pms.hasPermission('infra:redis:get-key-list')")
    public R<Set<String>> getKeyDefineList(@RequestParam("keyTemplate") String keyTemplate) {
    ...
    //@PreAuthorize("@pms.hasPermission('infra:redis:get-key-list')")
    public R<RedisKeyValueRespVO> getKeyValue(@RequestParam("key") String key) {
    ...
    @Parameter(name = "key", description = "Redis Key", example = "oauth2_access_token:233")
    //@PreAuthorize("@pms.hasPermission('infra:redis:get-key-list')")
    public R<Boolean> deleteKey(@RequestParam("key") String key) {
    ...
    @Parameter(name = "keyTemplate", description = "Redis Key 定义", example = "true")
    //@PreAuthorize("@pms.hasPermission('infra:redis:get-key-list')")
    public R<Boolean> deleteKeys(@RequestParam("keyTemplate") String keyTemplate) {
