package cn.cleanarch.dp.system.sys.controller.role;

import cn.cleanarch.dp.common.core.constant.CacheConstants;
import cn.cleanarch.dp.common.core.model.R;
import cn.cleanarch.dp.system.sys.service.role.SysRoleService;
import cn.cleanarch.dp.system.sys.dataobject.role.SysRoleDO;
import cn.cleanarch.dp.system.sys.vo.role.SysRoleMenuVO;
...
public class SysRoleController {
     ...
     */
    @GetMapping("/{id}")
    @PreAuthorize("@pms.hasPermission('system:sys-role:query')")
     ...
     */
    @PostMapping
    @PreAuthorize("@pms.hasPermission('system:sys-role:create')")
     ...
     */
    @PutMapping
    @PreAuthorize("@pms.hasPermission('system:sys-role:update')")
    @CacheEvict(value = CacheConstants.ROLE_DETAILS, allEntries = true)
     ...
     */
    @DeleteMapping("/{id}")
    @PreAuthorize("@pms.hasPermission('system:sys-role:delete')")
    @CacheEvict(value = CacheConstants.ROLE_DETAILS, allEntries = true)
