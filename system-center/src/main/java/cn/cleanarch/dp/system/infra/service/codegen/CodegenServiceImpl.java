package cn.cleanarch.dp.system.infra.service.codegen;
...
import cn.cleanarch.dp.system.infra.mapper.codegen.CodegenColumnMapper;
import cn.cleanarch.dp.system.infra.mapper.codegen.CodegenTableMapper;
import cn.cleanarch.dp.system.infra.service.codegen.inner.CodegenBuilder;
import cn.cleanarch.dp.system.infra.service.codegen.inner.CodegenEngine;
import cn.cleanarch.dp.system.infra.service.db.DatabaseTableService;
import cn.cleanarch.dp.system.infra.constants.CodegenSceneEnum;
import cn.cleanarch.dp.system.infra.convert.codegen.CodegenConvert;
import cn.cleanarch.dp.system.infra.dataobject.codegen.CodegenColumnDO;
import cn.cleanarch.dp.system.infra.dataobject.codegen.CodegenTableDO;
import cn.cleanarch.dp.system.infra.vo.codegen.CodegenCreateListReqVO;
import cn.cleanarch.dp.system.infra.vo.codegen.CodegenUpdateReqVO;
import cn.cleanarch.dp.system.infra.vo.codegen.table.CodegenTablePageReqVO;
import cn.cleanarch.dp.system.infra.vo.codegen.table.DatabaseTableRespVO;
...
public class CodegenServiceImpl implements CodegenService {
    ...
    public String createCodegen(String userId, Long dataSourceConfigId, String tableName) {
        // 从数据库中，获得数据库表结构
    ...
    private String createCodegen0(String userId, Long dataSourceConfigId, TableInfo tableInfo) {
        // 校验导入的表和字段非空
        ...
        table.setAuthor(AppContextHolder.getUser().getUsername());
